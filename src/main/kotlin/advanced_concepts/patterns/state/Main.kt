...
enum class UserState(
    ...
    ANONYMOUS(signUp = {
        println("Signing up with email: $email"); email = it; state = UNVERIFIED
    },
    ...
    UNVERIFIED(signUp = { println("You are already signed up") },
    ...
    AUTHENTICATED(signUp = { println("You are already signed up and authenticated") },
        ...
        editProfile = { println("Profile: Updating email from ${email} to $it");email = it })
}
